  ...
  return (
    <Card className="relative overflow-hidden border-[var(--destructive)]/30 dark:border-[var(--destructive)]/20 bg-[var(--destructive)]/[0.08] dark:bg-[var(--destructive)]/[0.04] rounded-2xl shadow-[var(--shadow-card)] h-full flex flex-col">
      ...
      <CardContent className="space-y-4 flex-1 flex flex-col justify-between">
        ...
        <Button
          variant="destructive"
          className="w-full rounded-full bg-[var(--destructive)] hover:bg-[var(--destructive)]/90 text-white border-0 transition-all active:scale-[0.97] cursor-pointer text-xs font-semibold shadow-sm h-9 mt-4"
